...
- [MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) - 数据格式参考以及代码参考
- [Playwright](https://playwright.dev/python/) - 浏览器自动化框架
以下是人工说的话
这个小东西是我前段时间在使用学习mediacrawler的时候发现没有人做了豆瓣的这个工具，于是我就是使用了glm5和opus4.6做了整体的一个工具，完全使用的ai开发感觉还不错呢。希望以后有人如果需要使用我这个小东西能帮上你的忙，不用从头才开始做了。
我是来自南京工业大学和扬州大学的一个双人团队，致力于使用ai开发让不懂代码的人也能使用代码和ai的工具，致力于推广ai技术的应用，将idea转化为现实！如果我的东西让您感觉到不适或者侵犯了您的合法权益，请联系我，我会改正的，我希望和大家能更加的一起进步学习！
我的联系方式：mail--2249462892@qq.com！
